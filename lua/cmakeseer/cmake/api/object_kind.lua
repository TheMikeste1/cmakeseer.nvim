...
--- @class cmakeseer.cmake.api.Version
--- @field major integer
--- @field minor integer

--- @class cmakeseer.cmake.api.ObjectKind One of the object kinds produced by the CMake file API.
--- @field kind cmakeseer.cmake.api.Kind The specific Kind of object.
--- @field version cmakeseer.cmake.api.Version The version of the ObjectKind.

local M = {}

--- @enum cmakeseer.cmake.api.Kind The kinds of objects available from the CMake file API.
M.Kind = {
  cache = "cache",
