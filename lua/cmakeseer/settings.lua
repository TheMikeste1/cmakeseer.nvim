...
---@type cmakeseer.CMakeSettings? The settings actually used.
local _settings = nil

local M = {}

---@return cmakeseer.CMakeSettings default_settings The default settings to use.
function M.get_default_settings()
  return require("cmakeseer").get_config().default_cmake_settings
end

---@return cmakeseer.CMakeSettings settings The current CMake settings.
function M.get_settings()
  _settings = _settings or M.get_default_settings()
  return _settings
end

---@param settings cmakeseer.CMakeSettings? The new settings to use. `nil` will reset to default. Will be taken by-copy.
