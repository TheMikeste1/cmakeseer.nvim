...
---@class neotest.cmakeseer.gtest.suite.Parameterized: neotest.cmakeseer.gtest.suite.Basic A suite with parameterized arguments. They have a prefix, but the postfix is added to the individual tests instead.
...
---@return neotest.cmakeseer.gtest.suite.Parameterized instance A new Parameterized instance.
function Parameterized:new(o)
  ---@class neotest.cmakeseer.gtest.suite.Parameterized
  o = Basic.new(self, o)
