---@class neotest.cmakeseer.gtest.suite.Basic A suite with no additional parameters or values. They have no prefix nor postfix.
...
---@return neotest.cmakeseer.gtest.suite.Basic instance A new Basic instance.
